...
* uptime: uptime -p
* mvImg: Move all images to a img folder in to the Download folder
* mvVid: Move all videos to a img folder in to the Download folder
* mvZip: Move all zip files to a img folder in to the Download folder
...
* fish-install: symlink of a fish script to the default fish function folder.
...
* toggle-locate-pointer:

### Script
* _bajar_res: Reduce resolution of a video (1080 or 720).
* _slow_down_audio: Reduce the audo speed of a mp3 file.
* _video_fixer: Fix codecs of video.

### TODO.TXT
* t: launch todo.txt
* ta: add task to todo.txt
* ts: list all task from todo.txt
